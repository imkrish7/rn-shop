import { StyleSheet, Text, View, Image ,Alert, Platform, TouchableOpacity, FlatList} from 'react-native'
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList data={items} keyExtractor={item=> item.id.toString()} renderItem={({item})=>{
        return <CartItem item={item} onDecrement={decrementItem} onIncrement={incrementItem} onRemove={removedItem} />
      }} />
